...
workflow ContEstMuTectOncotatorWorkflow
	...
	#Reference and Parametric Inputs
	File ReferenceFasta 
	File ContESTIntervals 
	File HapMapVCF 
	File SNP6Bed 
	...
	call ContEstTask {
		input: 
		normalBamHG19      = normalBamHG19,
		normalBamIndexHG19 = normalBamIndexHG19,
		tumorBamHG19       = tumorBamHG19,
		tumorBamIndexHG19  = tumorBamIndexHG19,		
		ReferenceFasta     = ReferenceFasta,
		ContESTIntervals   = ContESTIntervals,
		HapMapVCF          = HapMapVCF,
		SNP6Bed            = SNP6Bed
		}
	output {
		ContEstTask.contaminationFile
		}	
	...
	call MutectTask {
		...
		ContEstContamination = ContEstTask.contaminationFile
		}
	output {
		MutectTask.MAFLiteFile
		MutectTask.CallStatsFile
		}

	#Third call OncoTator
	call OncotatorTask {
		input: inputMAFLite = MutectTask.MAFLiteFile
		}
	output {
		OncotatorTask.oncotatorVCF
		OncotatorTask.oncotatorLog
		}



	#Finally call onco report
	call OncotatorReportTask {
		input:oncoVCFFile = OncotatorTask.oncotatorVCF
		}
	output {
		OncotatorReportTask.oncotatorHTMLReport
		}
	}