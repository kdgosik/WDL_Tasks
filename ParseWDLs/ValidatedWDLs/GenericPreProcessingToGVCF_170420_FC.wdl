...
## recommend 100).
##
## THIS WDL WAS MODIFIED FROM THE ORIGINAL (IN WDL REPO) TO MAKE IT WORK IN FIRECLOUD
##
...
## - A GVCF file of intermediate calls produced by HaplotypeCaller, suitable for 
##   joint discovery analysis.
##
## Cromwell version support 
## - Successfully tested on C25
## - Does not work on versions < C25 due to optional File input (C24 bug) and output 
##   syntax (unsupported < C23)
##
...
workflow GenericPreProcessingToGVCFWorkflow {
  ...
  String final_gvcf_name = base_file_name + ".g.vcf.gz"
