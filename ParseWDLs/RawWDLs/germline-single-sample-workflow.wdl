...
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:alignment/versions/1/plain-WDL/descriptor" as Alignment
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:split-large-readgroup/versions/3/plain-WDL/descriptor" as SplitRG
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:quality-control/versions/1/plain-WDL/descriptor" as QC
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:bam-processing/versions/5/plain-WDL/descriptor" as Processing
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:germline-variant-discovery/versions/3/plain-WDL/descriptor" as Calling
import "https://api.firecloud.org/ga4gh/v1/tools/gatk-workflows:utilities/versions/1/plain-WDL/descriptor" as Utils
