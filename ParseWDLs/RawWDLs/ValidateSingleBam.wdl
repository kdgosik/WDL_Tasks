...
## 
## This WDL validates a single SAM/BAM file
##
## Requirements/expectations :
## - SAM or BAM file to validate
## - Explicit request of either SUMMARY or VERBOSE mode
##
## Outputs:
## - Text file (.txt) containing the validation report
##
