...
import "https://api.firecloud.org/ga4gh/v1/tools/gatk:split-large-readgroup/versions/1/plain-WDL/descriptor" as SplitRG
import "https://api.firecloud.org/ga4gh/v1/tools/gatk:quality-control/versions/1/plain-WDL/descriptor" as QC
import "https://api.firecloud.org/ga4gh/v1/tools/gatk:bam-processing/versions/1/plain-WDL/descriptor" as Processing
