...
task OrientationBias_filter_Task {
  ...
  parameter_meta {
	...
	output  {
		...
		File WXS_Mutation_OBF_filtered_maf="out/${ID}.OrientationBiasFilter.maf"
		File WXS_Mutation_OBF_unfiltered_maf="out/${ID}.OrientationBiasFilter.unfiltered.maf"
		}
}
...
task pf_counter_task {
	...
	output {
		Int WXS_Mutation_unfiltered_count=read_int("all_count.dat")
		Int WXS_Mutation_count=read_int("pass_count.dat")
		}
...
task maf_merge_task {
  ...
  parameter_meta {
	...
	output {
		...
		File WXS_Mutation_union_maf="${PairID}.union.maf"
		File WXS_Mutation_intersection_maf="${PairID}.intersection.maf"
		}
...
workflow FilterWorkflow  {
    ...
    call pf_counter_task as obf_ffpe_counter {
    	input:
    		allMaf=ffpeOBF.WXS_Mutation_OBF_unfiltered_maf,
    		passMaf=ffpeOBF.WXS_Mutation_OBF_filtered_maf,
    		diskGB=sizesCalc.maf_disk
    	}

    call pf_counter_task as obf_oxoG_counter {
    	input:
    		allMaf=oxoGOBF.WXS_Mutation_OBF_unfiltered_maf,
    		passMaf=oxoGOBF.WXS_Mutation_OBF_filtered_maf,
    		diskGB=sizesCalc.maf_disk
    	}
	...
	call pf_counter_task as filtered_counter {
		input:
			allMaf=maf_merge_task.WXS_Mutation_union_maf,
			passMaf=maf_merge_task.WXS_Mutation_intersection_maf,
			diskGB=sizesCalc.maf_disk
		}
	...
	output {
		...
		maf_merge_task.WXS_Mutation_union_maf
		maf_merge_task.WXS_Mutation_intersection_maf
		filtered_counter.WXS_Mutation_unfiltered_count
		filtered_counter.WXS_Mutation_count
		oxoGOBF.WXS_Mutation_OBF_filtered_maf
		oxoGOBF.WXS_Mutation_OBF_unfiltered_maf
		ffpeOBF.WXS_Mutation_OBF_filtered_maf
		ffpeOBF.WXS_Mutation_OBF_unfiltered_maf
